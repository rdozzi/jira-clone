...
// Get project by Id
router.get('/projects/:projectId', (0, resolveProjectIdFromProject_1.resolveProjectIdFromProject)(), (0, checkProjectMembership_1.checkProjectMembership)({ allowGlobalSuperAdmin: true }), (0, checkProjectRole_1.checkProjectRole)(client_1.ProjectRole.VIEWER, { allowGlobalSuperAdmin: true }), async (req, res) => {
