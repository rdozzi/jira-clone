...
// Create project
router.post('/projects', (0, authorize_1.authorize)(client_1.GlobalRole.ADMIN), async (req, res, next) => {
    await (0, projectController_1.createProject)(req, res, next, prisma_1.default);
});
// Update project
router.patch('/projects/:id', (0, authorize_1.authorize)(client_1.GlobalRole.ADMIN), async (req, res, next) => {
    await (0, projectController_1.updateProject)(req, res, next, prisma_1.default);
});
// Delete project
router.delete('/projects/:id', (0, authorize_1.authorize)(client_1.GlobalRole.ADMIN), async (req, res, next) => {
